...
# Episode/Podcast created via conftest fixtures
...
class TestUpload:
    def test_successful_upload_returns_torrent_id(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
    ...
    def test_name_includes_podcast_episode_and_date(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**{**_EP_DEFAULTS, "published": "2024-03-15T10:00:00"})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_name_omits_date_when_published_is_none(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**{**_EP_DEFAULTS, "published": None})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_posts_category_and_type_ids(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_raises_if_category_id_missing(self, torrent_path, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
    ...
    def test_raises_if_type_id_missing(self, torrent_path, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
    ...
    def test_login_sends_credentials(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_upload_sends_csrf_token(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_includes_cover_image_when_configured(self, torrent_path, feed_config, tmp_path, make_episode, make_podcast):
    ...
    def test_includes_banner_image_when_configured(self, torrent_path, feed_config, tmp_path, make_episode, make_podcast):
    ...
    def test_excludes_images_when_not_configured(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_description_suffix_appended(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker(defaults={"anonymous": 0, "personal_release": 0, "mod_queue_opt_in": 0, "description_suffix": "Uploaded by Bot"})
        episode = make_episode(**{**_EP_DEFAULTS, "description": "A great episode."})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_description_suffix_with_empty_description(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker(defaults={"anonymous": 0, "personal_release": 0, "mod_queue_opt_in": 0, "description_suffix": "Uploaded by Bot"})
        episode = make_episode(**{**_EP_DEFAULTS, "description": None})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_description_without_suffix(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**{**_EP_DEFAULTS, "description": "A great episode."})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_hardcodes_media_db_ids_to_zero(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login()
    ...
    def test_raises_on_csrf_expired(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
    ...
    def test_raises_on_unexpected_upload_status(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
    ...
    def test_cover_image_override_takes_priority(self, torrent_path, feed_config, tmp_path, make_episode, make_podcast):
    ...
    def test_no_override_uses_feed_config_cover(self, torrent_path, feed_config, tmp_path, make_episode, make_podcast):
        config_cover = tmp_path / "config-cover.jpg"
        config_cover.write_bytes(b"config-jpeg")
        feed_with_cover = {**feed_config, "cover_image": str(config_cover)}
    ...
    def test_raises_with_errors_on_validation_failure(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_login(
...
class TestRememberCookie:
    def test_upload_with_remember_cookie(self, torrent_path, feed_config, make_episode, make_podcast):
    ...
    def test_skips_login_flow(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_cookie_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_cookie()
    ...
    def test_raises_on_expired_cookie(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_cookie_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
    ...
    def test_sends_csrf_token_from_create_page(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_cookie_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        client = _mock_client_for_cookie()
...
class TestLogin:
    def test_raises_on_2fa(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
    ...
    def test_raises_on_bad_credentials(self, torrent_path, feed_config, make_episode, make_podcast):
        tracker = _make_tracker()
        episode = make_episode(**_EP_DEFAULTS)
        podcast = make_podcast(**_PODCAST_DEFAULTS)
...
class TestConstructor:
    def test_raises_without_any_auth(self, make_episode, make_podcast):
    ...
    def test_accepts_remember_cookie_only(self, make_episode, make_podcast):
        tracker = _make_cookie_tracker()
        assert tracker._remember_cookie == "fake-remember-cookie-value"

    def test_accepts_username_password_only(self, make_episode, make_podcast):
        tracker = _make_tracker()
        assert tracker._username == "testuser"


class TestExtractCsrfToken:
    def test_extracts_token_name_first(self, make_episode, make_podcast):
        html = '<input type="hidden" name="_token" value="abc123">'
        assert _extract_csrf_token(html) == "abc123"

    def test_extracts_token_value_first(self, make_episode, make_podcast):
        html = '<input type="hidden" value="xyz789" name="_token">'
        assert _extract_csrf_token(html) == "xyz789"

    def test_raises_when_no_token(self, make_episode, make_podcast):
...
class TestExtractTorrentId:
    def test_extracts_id_from_url(self, make_episode, make_podcast):
        assert _extract_torrent_id("/torrents/42") == 42

    def test_extracts_id_from_full_url(self, make_episode, make_podcast):
        assert _extract_torrent_id("https://tracker.example.com/torrents/123") == 123

    def test_returns_none_for_no_match(self, make_episode, make_podcast):
        assert _extract_torrent_id("/other/page") is None


class TestExtractValidationErrors:
    def test_extracts_li_errors(self, make_episode, make_podcast):
    ...
    def test_strips_html_tags_from_errors(self, make_episode, make_podcast):
    ...
    def test_returns_empty_list_when_no_errors(self, make_episode, make_podcast):
        html = '<html><body>No errors here</body></html>'
        assert _extract_validation_errors(html) == []


class TestFromConfig:
    def test_constructs_with_remember_cookie(self, make_episode, make_podcast):
    ...
    def test_constructs_with_username_password(self, make_episode, make_podcast):
        tracker = ModifiedUnit3dTracker.from_config({
            "url": "https://tracker.example.com",
            "username": "user",
            "password": "pass",
    ...
    def test_defaults_to_zero_for_optional_flags(self, make_episode, make_podcast):
        tracker = ModifiedUnit3dTracker.from_config({
            "url": "https://tracker.example.com",
    ...
    def test_description_suffix_from_config(self, make_episode, make_podcast):
        tracker = ModifiedUnit3dTracker.from_config({
            "url": "https://tracker.example.com",
            "remember_cookie": "cookie",
            "announce_url": "https://tracker.example.com/announce/x/announce",
...
class TestBuildTorrentName:
    def test_with_date_and_bitrate(self, make_episode, make_podcast):
        episode = make_episode(**{**_EP_DEFAULTS, "published": "Fri, 15 Mar 2024 06:00:00 +0000"})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
    ...
    def test_with_date_no_audio(self, make_episode, make_podcast):
        episode = make_episode(**{**_EP_DEFAULTS, "published": "Fri, 15 Mar 2024 06:00:00 +0000"})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        feed_config = {}
    ...
    def test_no_date_no_audio(self, make_episode, make_podcast):
        episode = make_episode(**{**_EP_DEFAULTS, "published": None})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        feed_config = {}
    ...
    def test_title_override(self, make_episode, make_podcast):
        episode = make_episode(**{**_EP_DEFAULTS, "published": "Fri, 15 Mar 2024 06:00:00 +0000"})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
    ...
    def test_iso_date_format(self, make_episode, make_podcast):
        episode = make_episode(**{**_EP_DEFAULTS, "published": "2024-03-15T10:00:00"})
        podcast = make_podcast(**_PODCAST_DEFAULTS)
        feed_config = {}
...
class TestGetMp3Bitrate:
    def test_reads_bitrate_from_mp3(self, make_episode, make_podcast):
        mock_info = MagicMock()
    ...
    def test_rounds_down_to_kbps(self, make_episode, make_podcast):
        mock_info = MagicMock()
