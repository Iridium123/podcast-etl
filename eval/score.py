...
class MatchResult:
    ...
    false_positives: list[AdSegment]
    false_negatives: list[AdSegment]
...
def match_segments(
    ...
    """Match predicted segments to gold segments. Each gold matches at most one
    prediction (best overlap), and each prediction matches at most one gold."""
...
class EpisodeScore:
    ...
    content_lost_seconds: float
    ads_missed_seconds: float
